...
WITH all_combinations AS (
    ...
    FROM (SELECT DISTINCT Region FROM world_bank_data.wdi_country) r
    CROSS JOIN (SELECT DISTINCT `Income Group` FROM world_bank_data.wdi_country) i
),
